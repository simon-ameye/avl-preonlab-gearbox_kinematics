...
"""
#gearbox data
gears_names = ["l1_g1", "l2_g1", "l2_g2", "l2_g3", "l5_g1", "l6_g1", "l4_g1", "l3_g1"]
nb_of_teeth = [15, 55, 12, 88, 24, 32, 12, 12]
lines = ["l1", "l2", "l2", "l2", "l5", "l6", "l4", "l3"]
gears_contacts = [
    ["l1_g1", "l2_g1"],
    ["l3_g1", "l2_g2"],
    ["l2_g3", "l4_g1"],
...
input_gear = "l1_g1"
input_rotation_speeds = [200, -500, -100, 1000] #RPS
